                ...
                <div class="form-bx001">
                    ...
                    <form action="" class="">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control form-control-lg" placeholder="Vad vill du saka efter...">
                        ...
                        <div class="form-group range-bx01">
                            <p>0</p>
                            <input type="range" value="40" min="1" max="100" class="form-control-range" id="formControlRange myinput" oninput="this.nextElementSibling.value = this.value"><output>40</output>
