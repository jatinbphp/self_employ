            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="form-serch-bx">
                        <h2>Browser</h2>
                        <form action="{{ route('jobs.view.category.search') }}" method="get">
                            @csrf
                            <div class="input-group mb-3">
                                <div class="search-bx1">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                    <input type="search" name="name" class="form-control form-control-lg"
            ...
            <div class="row">
                <div class="top-result-bx">
                    ...
                    <div class="result-rightbx1">
                        <p>Sort by</p>
                        <div class="dropdown">
                            <select class="form-select" name="orderBy" aria-label="Latest">
                        ...
                        @foreach ($categories as $category)
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="flexCheckDefault_{{ $loop->iteration }}">
                                    <a style="color:white !important;text-decoration:none"
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            ...
                                                            {{ $job->location }} - {{ round($job->distance) }} m
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
