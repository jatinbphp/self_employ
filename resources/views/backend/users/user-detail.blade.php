        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <a href="{{route('admin.user')}}" class="text-muted text-hover-primary">Users</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <div class="me-4">
                    ...
                    <!--begin::Menu 1-->
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61484e931f7e4">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                        ...
                        <div class="px-7 py-5">
                            ...
                            <div class="mb-10">
                                ...
                                <!--begin::Input-->
                                <div>
                                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61484e931f7e4" data-allow-clear="true">
                                        <option></option>
            ...
            <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-center flex-column py-5">
                                ...
                                <div class="mb-9">
                                    <!--begin::Badge-->
                                    <div class="badge badge-lg badge-light-primary d-inline">{{$user->getRoles->name}}</div>
                                    <!--begin::Badge-->
                                </div>
                                <!--end::Position-->
                                <!--begin::Info-->
                                <!--begin::Info heading-->
                                <div class="fw-bolder mb-3">Details
                                ...
                                <div class="d-flex flex-wrap flex-center">
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                        <div class="fs-4 fw-bolder text-gray-700">
                                            <span class="w-75px">{{count($user->getJobPosted)}}</span>
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                        <div class="fs-4 fw-bolder text-gray-700">
                                            <span class="w-50px">{{count($user->getJobPosted)}}</span>
                                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
                                            <span class="svg-icon svg-icon-3 svg-icon-success">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <rect opacity="0.5" x="13" y="6" width="13" height="2" rx="1" transform="rotate(90 13 6)" fill="black" />
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <div class="text-gray-600">{{$user->billing_address}}</div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bolder mt-5">Shipping Address</div>
                                    <div class="text-gray-600">{{$user->shipping_address}}</div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bolder mt-5">Language</div>
                                    <div class="text-gray-600">{{$user->language}}</div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bolder mt-5">Last Login</div>
                                    <div class="text-gray-600">{{$user->last_login2}}</div>
                                    <!-- <div class="text-gray-600">25 Jul 2021, 10:10 pm</div> -->
                                    <!--begin::Details item-->
                                </div>
                            </div>
                            <!--end::Details content-->
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                        ...
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_user_view_overview_events_and_logs_tab">Login History</a>
                        </li>
                        <!--end:::Tab item-->
                            ...
                            <div class="card card-flush mb-6 mb-xl-9">
                                ...
                                <div class="card-header mt-6">
                                    ...
                                    <div class="card-title flex-column">
                                        ...
                                        <div class="fs-6 fw-bold text-muted">Total {{count($user->getJobPosted)}} tasks</div>
                                    </div>
                                    <!-- <div class="card-toolbar">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    @foreach($user->getJobPosted as $job)
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <!--begin::Details-->
                                        <div class="fw-bold ms-5">
                                            <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary">{{$job->name}}</a>
                                            <br>
                                            <span>{{$job->getPostCategory->name}}</span>
                                            <ol class="breadcrumb breadcrumb-line text-muted fs-6 fw-bold">
                                                @foreach($job->getPostCategory->getSkills as $skill)
                                            ...
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted">Due: {{$job->due_date}}
                                                <!-- <a href="#"></a> -->
                                            </div>
                                        </div>
                                ...
                                <div class="card-body pt-0 pb-5">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table align-middle table-row-dashed gy-5" id="kt_table_users_login_session">
                                            ...
                                            <!--begin::Table body-->
                                            <tbody class="fs-6 fw-bold text-gray-600">
                                                @foreach($user->getUserLoginHistory as $history)
                                                <tr>
                                                    <!--begin::Invoice=-->
