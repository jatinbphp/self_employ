    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Add Skill</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Add Skill</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                        ...
                        <div class="w-lg-550px bg-body rounded p-10 p-lg-15 mx-auto">
                            ...
                            @endforeach
                            @endif
                            <form class="form w-100" novalidate="novalidate" method="post" action="{{route('admin.skills.store')}}">
                                @csrf
                                <!--begin::Heading-->
                                <div class="text-center mb-10">
                                    <!--begin::Title-->
                                    <h1 class="text-dark mb-3">Add Skill</h1>
                                    <!--end::Title-->
                                </div>
                                <!--begin::Heading-->
                                <!--begin::Input group-->
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select class="form-select form-select-solid {{$errors->has('category_id') ? 'is-invalid' : ''}}" aria-label="Select example" id="sub_category" name="category_id" required>
                                    </select>
                                    @error('category_id')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                ...
                                <div class="fv-row mb-7 clone_data">
                                    ...
                                    <div class="d-flex">
                                        <input class="form-control form-control-lg form-control-solid {{$errors->has('name') ? 'is-invalid' : ''}}" type="text" placeholder="Enter Name" name="name[]" value="" autocomplete="off" required />
                                        <i class="btn btn-primary bi bi-plus-lg add-clone"></i>
                                        @error('name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
